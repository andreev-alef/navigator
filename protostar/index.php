            ...
            <header class="header" role="banner">
                <div class="header-inner clearfix">
                    <a class="brand pull-left" href="<?php echo $this->baseurl; ?>/">
                        <img class="logo" src="/navigator/images/logo_nmc.jpg" alt="НАВИГАТОР">
                        <div class="site-description">
                            Навигатор<br />дополнительного образования детей
                            <br /> г. Кемерово
                        </div>
                        <?php
// echo $logo;
//if ($this->params->get('sitedescription')) :
//    echo '<div class="site-description">' . htmlspecialchars($this->params->get('sitedescription'), ENT_COMPAT, 'UTF-8') . '</div>';
//endif;
                        ?>
                    </a>
